...
case $choice in
    1)
       ...
       pip3 install .
        ...
        cd /opt/ 
        curl --request GET \
        --url 'https://www.tenable.com/downloads/api/v2/pages/nessus/files/Nessus-10.8.0-ubuntu1604_amd64.deb' \
        --output 'Nessus-10.8.0-ubuntu1604_amd64.deb'
        dpkg -i Nessus-10.8.0-ubuntu1604_amd64.deb
        rm Nessus-10.8.0-ubuntu1604_amd64.deb
