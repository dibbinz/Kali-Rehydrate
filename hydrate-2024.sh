...
#Version 0.1.4
#Updated: Added automated install of offcial latest version of TeamViewer 
...
/_/ |_/_____/_/ /_/   /_/_____/_/ |_/_/  |_/_/ /_____/   v0.1.4   
"
...
case $choice in
    1)
        ...
        if ! command -v teamviewer &> /dev/null; then
            ...
            blue_echo "TeamViewer is already installed."
        fi
